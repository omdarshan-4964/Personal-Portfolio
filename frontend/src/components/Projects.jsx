...
const Projects = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            fullDescription: 'A comprehensive event management system that handles everything from event creation to attendee registration. Built with modern web technologies to provide a seamless user experience for both organizers and participants.',
